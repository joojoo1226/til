...
<body>
	<h1>회원가입</h1>
	<br>
	<form action="join_pro.jsp"  method="post" name="fr">
		<table border="1">
			<tr>
				<td>이름</td>
				<td>
...
<!-- 					onkeyup : 음절별로 체크 -->
			...
			<tr>
				...
				<td>
					<select name="job">
						<option selected="selected">항목을 선택하세요</option>
						<option>건물주</option>
						<option>구직자</option>
						<option>강사님❤️</option>
					</select>
			...
			<tr>
				<td>성별</td>
				<td>
					<input type="radio" name="gender" checked="checked" value="남"> 남성
			...
			<tr>
				<td>가입동기</td>
				<td>
					<textarea rows="10" cols="35" name="content">안녕하세요.</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
